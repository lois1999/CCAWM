...
parser.add_argument('--split',
                    choices = ['simple_scan','addjump_scan','simple_nacs','addjump_nacs',
                     ...
                     'split2_nacs', 'jumpo_nacs', 'uniquesuffix_nacs', 'verbarg_scan', 'verbarg_nacs', 
                     'simplesplit1_scan', 'simplesplit1_nacs'],
...
parser.add_argument('--dim_feedforward', type=int, default=78,
